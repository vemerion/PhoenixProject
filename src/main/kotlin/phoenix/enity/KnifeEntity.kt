        ...
        if (!world.isRemote)
        {
            ...
            if(owner is LivingEntity)
            {
                when (result.type)
                {
                    ENTITY ->
                    {
                        dropItem = dropItem && (knife.item as KnifeItem).onHitEntity(
                            world,
                            owner,
                            this,
                            (result as EntityRayTraceResult).entity,
                            knife
                        )
                    ...
                    BLOCK  ->
                    {
                        ...
                        dropItem =
                            dropItem and (knife.item as KnifeItem).onHitBlock(world, owner, result.pos, this, knife)

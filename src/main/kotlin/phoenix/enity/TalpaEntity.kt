...
class TalpaEntity(type: EntityType<TalpaEntity>, worldIn: World) : AnimalEntity(type, worldIn)
{
    ...
    override fun getPoseAABB(pose: Pose): AxisAlignedBB? = if (isEntityInsideOpaqueBlock) null else super.getPoseAABB(pose)
    ...
    override fun registerGoals()
    {
        ...
        goalSelector.addGoal(3, TemptGoal(this, 0.5, Ingredient.fromItems(PhoenixBlocks.SETA), false))

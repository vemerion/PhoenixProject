...
public class StageManager
{
    ...
    public static void setStage(int stage, EndBiomeProvider provider)
    {
        data.putInt("stage", stage);
        provider.setGenBiomes(provider.createLayer(provider.getSeed()));
    }
    ...
    public static void addStage(EndBiomeProvider provider)
    {
    ...
    public static void addPart(EndBiomeProvider provider)
    {
        setPart(getPart() + 1);
        if(data.getInt("part") >= 3)
        {
    ...
    public enum Stage
    {
        ASH
            {
                @Override
                public void createTower(EndSpikeFeature future, IWorld world, EndSpikeFeature.EndSpike spike)
                {
                    if (spike.isGuarded())
                    {
        ...
        public abstract void createTower(EndSpikeFeature future, IWorld world, EndSpikeFeature.EndSpike spike);
    }
}

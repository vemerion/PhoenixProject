...
import phoenix.utils.ArrayUtils.part
import phoenix.utils.until
import java.util.*
...
class DiaryChapter
{
    ...
    constructor(xSizeIn: Int, ySizeIn: Int, vararg elementsIn: ADiaryElement) : this(xSizeIn, ySizeIn, ImmutableList.copyOf<ADiaryElement>(elementsIn))

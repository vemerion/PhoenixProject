...
class PipeModel(stateIn: BlockState) : Model({ PhoenixRenderTypes.PIPE })
{
    ...
    init
    {
        ...
        u = ModelRenderer(this, 0, 12)
        d = ModelRenderer(this, 0, 12)
        base.setRotationPoint(6f, 6f, 6f)
        n.setRotationPoint(6f, 6f, 0f)
        s.setRotationPoint(6f, 6f, 6f + 4f)
        e.setRotationPoint(6f + 4f, 6f, 6f)
        w.setRotationPoint(0f, 6f, 6f)
        u.setRotationPoint(6f, 6f + 4f, 6f)

...
public class RenderUtils
{
    ...
    public static void drawTexturedRectWithSize(MatrixStack stack, ResourceLocation texture, int textureSizeX, int textureSizeY, int x, int y, int sizeX, int sizeY, int blitOffset, int u, int v)
    {
        RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        Minecraft.getInstance().getTextureManager().bindTexture(texture);
        AbstractGui.blit(stack, x, y, blitOffset, (float) u, (float) v, sizeX, sizeY, textureSizeX, textureSizeY);
    }

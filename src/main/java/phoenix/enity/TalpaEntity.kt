...
class TalpaEntity(type: EntityType<TalpaEntity>, worldIn: World) : AnimalEntity(type, worldIn)
{
    ...
    companion object
    {
        init
        {
            ...
            GlobalEntityTypeAttributes.put(PhoenixEntities.TALPA.get(), map.create())
        }
    }
    ...
    override fun func_241840_a(world: ServerWorld, ageable: AgeableEntity)= TalpaEntity(PhoenixEntities.TALPA.get(), world)

...
public class PhoenixRenderTypes
{
    ...
    {
        TANK = initTexture(ResourceUtils.block("tank"), "tank");
        PIPE = initTexture(ResourceUtils.block("pipe_"),  "pipe_");
    }
    ...
    {
        return RenderType.makeType(ResourceUtils.key(name).toString(), DefaultVertexFormats.POSITION_COLOR_TEX, GL11.GL_QUADS, 32768, false, false, state);
    }
}
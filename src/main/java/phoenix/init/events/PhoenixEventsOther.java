...
public class PhoenixEventsOther
{
    ...
    public static void cornGen(EntityJoinWorldEvent event)
    {
        ...
        if(!world.isRemote && world.getDimensionType() == DimensionType.END_TYPE && !GenSaveData.get((ServerWorld) world).isCornGenned())
        {
            ...
            if(template != null)
            {
                ...
                template.func_237144_a_((IServerWorld) world, new BlockPos(1000, 100, 1000), new PlacementSettings(), world.rand);
                template.func_237144_a_((IServerWorld) world, new BlockPos(-1000, 100, 1000), new PlacementSettings(), world.rand);
                template.func_237144_a_((IServerWorld) world, new BlockPos(1000, 100, -1000), new PlacementSettings(), world.rand);
                template.func_237144_a_((IServerWorld) world, new BlockPos(-1000, 100, -1000), new PlacementSettings(), world.rand);

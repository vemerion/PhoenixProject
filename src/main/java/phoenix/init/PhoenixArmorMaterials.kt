...
enum class PhoenixArmorMaterials(
    ...
    private val knockbackResistanse : Float) : IArmorMaterial
{
    STEEL(20f, arrayOf(2, 5, 6, 4), 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, ({ Ingredient.fromItems(PhoenixItems.STEEL_INGOT.get())}), "steel", 0f, 10f);
    ...
    override fun getKnockbackResistance()                            = knockbackResistanse
}
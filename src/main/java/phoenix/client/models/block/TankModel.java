...
public class TankModel extends Model
{
    ...
    public RenderMaterial MATERIAL_FLUID;
    public static final RenderMaterial TEXTURE = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS_TEXTURE,
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer buffer, int packedLightIn, int packedOverlayIn)
    {
        ...
        {
            MATERIAL_FLUID = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS_TEXTURE, TEXTURE_FLUID);
            ...
            {
                if (tileTank.getWorld().getDimensionType() == DimensionType.END_TYPE)
                {

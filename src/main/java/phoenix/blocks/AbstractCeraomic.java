...
import phoenix.client.sound.CeraomicSoundType;

import javax.annotation.Nullable;

public abstract class AbstractCeraomic extends Block
{
    ...
    @Override public SoundType getSoundType() { return CeraomicSoundType.TEST;  }
}

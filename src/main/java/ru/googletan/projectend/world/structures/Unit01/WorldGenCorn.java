package ru.googletan.projectend.world.structures.Unit01;
...
{
    private static final ResourceLocation CORN = new ResourceLocation(Projectend.MOD_ID + ":temple_end");
    @Override
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
    {
        ...
        template.addBlocksToWorld(world, new BlockPos(chunkX * 16 + random.nextInt(200), 100 + random.nextInt(20), chunkZ * 16 + random.nextInt(200)), settings);
    }
}

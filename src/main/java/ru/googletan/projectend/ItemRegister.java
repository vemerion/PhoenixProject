...
import ru.googletan.projectend.Items.TestItem;
import ru.googletan.projectend.Items.twoAir.ItemKassiysSpeaare;

@GameRegistry.ObjectHolder(Projectend.MOD_ID)
@Mod.EventBusSubscriber
public class ItemRegister
{
    @GameRegistry.ObjectHolder("testitem")
    public static final Item TESTITEM = null;
    @GameRegistry.ObjectHolder("kassiesspeare")
    public static final Item KassiesSpeare = null;
    @SubscribeEvent
    public static void onRegistryItem(RegistryEvent.Register<Item> e)
    {
        e.getRegistry().register(new TestItem("testitem"));
        e.getRegistry().register(new ItemKassiysSpeaare("kassiesspeare"));
    }

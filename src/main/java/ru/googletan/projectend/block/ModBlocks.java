...
import ru.googletan.projectend.block.fluid.ModBlockFluidClassic;
import ru.googletan.projectend.block.fluid.ModFluids;
...
public class ModBlocks 
{
	...
	public static void registerBlocks(RegistryEvent.Register<Block> event) 
	{
		...
		reggy.register(new ModBlockFluidClassic(ModFluids.ACID, Material.WATER).setRegistryName("endacid"));// new MaterialLiquid(MapColor.PURPLE)).setRegistryName("endacid").setUnlocalizedName("stygian:endacid"));
	}
